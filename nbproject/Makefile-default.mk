...
SOURCEFILES_QUOTED_IF_SPACED=src/anChevrons.cpp src/anColorFlowSA.cpp src/anColorRaceSA.cpp src/anComets.cpp src/anFadeMiddle.cpp src/anPulseFadeSA.cpp src/anRain.cpp src/anRainbowChaser.cpp src/anSplatterSA.cpp src/counter.cpp src/fft.cpp src/io.cpp src/main.cpp src/Neopixel.cpp src/npAnimation.cpp src/npDisplay.cpp src/rgbColor.cpp src/anTest.cpp src/pixel.cpp src/anClassicSA.cpp src/anTetrisSA.cpp src/sprite.cpp src/matrix.cpp

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/anChevrons.o ${OBJECTDIR}/src/anColorFlowSA.o ${OBJECTDIR}/src/anColorRaceSA.o ${OBJECTDIR}/src/anComets.o ${OBJECTDIR}/src/anFadeMiddle.o ${OBJECTDIR}/src/anPulseFadeSA.o ${OBJECTDIR}/src/anRain.o ${OBJECTDIR}/src/anRainbowChaser.o ${OBJECTDIR}/src/anSplatterSA.o ${OBJECTDIR}/src/counter.o ${OBJECTDIR}/src/fft.o ${OBJECTDIR}/src/io.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/Neopixel.o ${OBJECTDIR}/src/npAnimation.o ${OBJECTDIR}/src/npDisplay.o ${OBJECTDIR}/src/rgbColor.o ${OBJECTDIR}/src/anTest.o ${OBJECTDIR}/src/pixel.o ${OBJECTDIR}/src/anClassicSA.o ${OBJECTDIR}/src/anTetrisSA.o ${OBJECTDIR}/src/sprite.o ${OBJECTDIR}/src/matrix.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/src/anChevrons.o ${OBJECTDIR}/src/anColorFlowSA.o ${OBJECTDIR}/src/anColorRaceSA.o ${OBJECTDIR}/src/anComets.o ${OBJECTDIR}/src/anFadeMiddle.o ${OBJECTDIR}/src/anPulseFadeSA.o ${OBJECTDIR}/src/anRain.o ${OBJECTDIR}/src/anRainbowChaser.o ${OBJECTDIR}/src/anSplatterSA.o ${OBJECTDIR}/src/counter.o ${OBJECTDIR}/src/fft.o ${OBJECTDIR}/src/io.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/Neopixel.o ${OBJECTDIR}/src/npAnimation.o ${OBJECTDIR}/src/npDisplay.o ${OBJECTDIR}/src/rgbColor.o ${OBJECTDIR}/src/anTest.o ${OBJECTDIR}/src/pixel.o ${OBJECTDIR}/src/anClassicSA.o ${OBJECTDIR}/src/anTetrisSA.o ${OBJECTDIR}/src/sprite.o ${OBJECTDIR}/src/matrix.o

# Source Files
SOURCEFILES=src/anChevrons.cpp src/anColorFlowSA.cpp src/anColorRaceSA.cpp src/anComets.cpp src/anFadeMiddle.cpp src/anPulseFadeSA.cpp src/anRain.cpp src/anRainbowChaser.cpp src/anSplatterSA.cpp src/counter.cpp src/fft.cpp src/io.cpp src/main.cpp src/Neopixel.cpp src/npAnimation.cpp src/npDisplay.cpp src/rgbColor.cpp src/anTest.cpp src/pixel.cpp src/anClassicSA.cpp src/anTetrisSA.cpp src/sprite.cpp src/matrix.cpp
...
${OBJECTDIR}/src/anClassicSA.o: src/anClassicSA.cpp  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/anClassicSA.o.d 
	@${RM} ${OBJECTDIR}/src/anClassicSA.o 
	@${FIXDEPS} "${OBJECTDIR}/src/anClassicSA.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CPPC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -fframe-base-loclist  -x c++ -c -mprocessor=$(MP_PROCESSOR_OPTION)  -frtti -fexceptions -fno-check-new -fno-enforce-eh-specs -O1 -MMD -MF "${OBJECTDIR}/src/anClassicSA.o.d" -o ${OBJECTDIR}/src/anClassicSA.o src/anClassicSA.cpp   -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/src/anTetrisSA.o: src/anTetrisSA.cpp  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
...
${OBJECTDIR}/src/matrix.o: src/matrix.cpp  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/matrix.o.d 
	@${RM} ${OBJECTDIR}/src/matrix.o 
	@${FIXDEPS} "${OBJECTDIR}/src/matrix.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CPPC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -fframe-base-loclist  -x c++ -c -mprocessor=$(MP_PROCESSOR_OPTION)  -frtti -fexceptions -fno-check-new -fno-enforce-eh-specs -O1 -MMD -MF "${OBJECTDIR}/src/matrix.o.d" -o ${OBJECTDIR}/src/matrix.o src/matrix.cpp   -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/matrix.o: src/matrix.cpp  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/matrix.o.d 
	@${RM} ${OBJECTDIR}/src/matrix.o 
	@${FIXDEPS} "${OBJECTDIR}/src/matrix.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CPPC} $(MP_EXTRA_CC_PRE)  -g -x c++ -c -mprocessor=$(MP_PROCESSOR_OPTION)  -frtti -fexceptions -fno-check-new -fno-enforce-eh-specs -O1 -MMD -MF "${OBJECTDIR}/src/matrix.o.d" -o ${OBJECTDIR}/src/matrix.o src/matrix.cpp   -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/LEDCanvas.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CPPC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_SIMULATOR=1 -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -o dist/${CND_CONF}/${IMAGE_TYPE}/LEDCanvas.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)      -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1,--defsym=_min_heap_size=32767,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/LEDCanvas.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CPPC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -o dist/${CND_CONF}/${IMAGE_TYPE}/LEDCanvas.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=32767,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
